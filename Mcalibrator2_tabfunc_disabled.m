function varargout = Mcalibrator2(varargin)
  ...
  % Mcalibrator2 -- display luminance/chromaticity characterization software package (tabfunc functionality disabled version).
  % function varargout = Mcalibrator2(varargin)
  %
  ...
  % Last Update: "2013-12-12 13:33:59 ban"
  % <a
