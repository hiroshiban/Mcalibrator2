...
% A wrapper function of AutoColorEstimateLinearGrid to call it from Mcalibrator2 with GUI-based data handling.
% function calculator_auto_estimation_linear_grid(hObject, eventdata, handles)
%
...
% Last Update: "2013-12-12 14:52:25 ban"
...
% save the results
save(save_fname,'-append','lineargrid_estimate');
