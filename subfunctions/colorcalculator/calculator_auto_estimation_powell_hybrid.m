...
powel_hybrid_estimate=AutoColorEstimatePowellHybrid(rawxyY,myxyY,myphosphers,flare_XYZ,lut,colorimeterhandler,displayhandler,options);
...
for mm=1:1:size(myxyY,2)
  ...
  PlotCIE1931xy(powel_hybrid_estimate{mm}.final_xyY(1:2),phosphers,0,1,1,0);
