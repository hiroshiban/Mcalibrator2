...
ratioadjust_estimate=AutoColorEstimateLinearCoeff(rawxyY,myxyY,myphosphers,lut,colorimeterhandler,displayhandler,options);
...
for mm=1:1:size(myxyY,2)
  ...
  PlotCIE1931xy(ratioadjust_estimate{mm}.final_xyY(1:2),phosphers,0,1,1,0);
