...
nonlinear_estimate=AutoColorEstimateNonLinear(rawxyY,myxyY,myphosphers,lut,colorimeterhandler,displayhandler,options);
...
for mm=1:1:size(myxyY,2)
  ...
  PlotCIE1931xy(nonlinear_estimate{mm}.final_xyY(1:2),phosphers,0,1,1,0);
