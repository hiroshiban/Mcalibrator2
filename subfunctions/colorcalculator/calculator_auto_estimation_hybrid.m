...
% A wrapper function of AutoColorEstimateHybrid to call it from Mcalibrator2 with GUI-based data handling.
% function calculator_auto_estimation_hybrid(hObject, eventdata, handles)
%
...
for mm=1:1:size(myxyY,2)
  ...
  PlotCIE1931xy(hybrid_estimate{mm}.final_xyY(1:2),phosphors,0,1,1,0);
