...
options.ss1=1.0;
linear_estimate=AutoColorEstimateLinear(rawxyY,myxyY,myphosphers,flare_XYZ,lut,colorimeterhandler,displayhandler,options);
...
for mm=1:1:size(myxyY,2)
  ...
  PlotCIE1931xy(linear_estimate{mm}.final_xyY(1:2),phosphers,0,1,1,0);
