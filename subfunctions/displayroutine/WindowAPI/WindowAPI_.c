...
// WindowAPI(FigureHandle, Command, [Flag])
// INPUT:
...
//   Matlab >=2014b:  mex -O -DHAS_HG2 WindowAPI_.c
//   Matlab < 2014b:  mex -O WindowAPI_.c
...
/*
% $JRev: R-U V:089 Sum:xTEO2grWwfrX Date:21-Oct-2016 23:28:54 $
% $License: BSD (use/copy/change/redistribute on own risk, mention the author) $
% $UnitTest: uTest_WindowAPI $
% $File: Tools\Mex\Source\WindowAPI_.c $
% History:
