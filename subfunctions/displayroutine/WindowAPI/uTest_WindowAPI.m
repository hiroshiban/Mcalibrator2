...
% Author: Jan Simon, Heidelberg, (C) 2009-2012 matlab.2010(a)n(MINUS)simon.de

% $JRev: R-j V:009 Sum:346aypRJHKoK Date:28-Jul-2013 15:03:20 $
...
if hasHG2
   try
      ...
      fprintf('  ok: DOUBLE handle accepted.\n');
   catch ME
      error(ErrID, '*** %s: DOUBLE handle crashed:\n%s', FuncName, ME.message);
   end
end
