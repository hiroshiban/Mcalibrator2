function xyY=generate_random_xyY_in_xyY_for_test(phosphors,num_xyY,flares,limits)

% Generates random xyY values for testing Mcalibrator2 functions (random values are generated in "xyY" space).
% function xyY=generate_random_xyY_in_xyY_for_test(phosphors,:num_xyY,:flares,:limits)
% (: is optional)
%
